...
class TermsController {
  ...
  public function page() {
    ...
    Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to my-drupal.com.
    ...
    Website refers to my-drupal.com, accessible from my-drupal.com
    ...
    By email: my_drupal@example.com';
